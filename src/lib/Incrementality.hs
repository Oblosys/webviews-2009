...
getWidgetInternalId  (TextWidget (TextView id _ _ _ _)) = id
getWidgetInternalId  (RadioViewWidget (RadioView id _ _ _ _)) = id
getWidgetInternalId  (SelectViewWidget (SelectView id _ _ _ _)) = id
